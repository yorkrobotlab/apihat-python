...
void setup_motors(){
  ...
  pinMode(motor_1_brakemode, OUTPUT);
  pinMode(motor_2_direction, OUTPUT);
  pinMode(motor_2_brakemode, OUTPUT);
  ...
  digitalWrite(motor_2_direction, 0);
  digitalWrite(motor_2_brakemode, 0);
  analogWrite(motor_2_pwm, 0);
  digitalWrite(motor_1_direction, 0);
  digitalWrite(motor_1_brakemode, 0);
